...
import org.fisco.bcos.asset.contract.Asset.SettlementEventEventResponse;
...
public class AssetClient {
	...
	public void SettlementAssetAmount() {
		try {
			String contractAddress = loadAssetAddr();
			...
			logger.error(" SettlementAssetAmount exception, error message is {}", e.getMessage());

			System.out.printf(" Settlement asset account failed, error message is %s\n", e.getMessage());
		}
	}
	...
	public static void Usage() {
		...
		System.out.println("\t java -cp conf/:lib/*:apps/* org.fisco.bcos.asset.client.AssetClient Settlement");
